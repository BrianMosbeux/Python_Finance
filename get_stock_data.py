...
def download_stocks_as_csv_files(tickers, start=dt.datetime(2000, 1, 1), end=dt.datetime.today()):
...
def get_sp500_data_from_yahoo(reload_sp500=False):
	...
	download_stocks_as_csv_files(tickers=tickers, start=start, end=end)
